 ...
 */
public class ConsultaPassadaMedicoAdapter extends BaseExpandableListAdapter {
    ...
    public ConsultaPassadaMedicoAdapter(Context context, List<ConsultaDTO> consultas) {
    ...
    public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        textConsultaPassadaHeaderMed.setText(headerTitle.getUsuario().getNome());
